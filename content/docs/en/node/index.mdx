...
- **REST API & gRPC Support**: Choose your preferred communication protocol
...
Get started with PasarGuard Node using our one-click installation:
...
We ❤️‍🔥 contributors! Check out our [Contributing Guidelines](https://github.com/PasarGuard/node/blob/main/CONTRIBUTING.md) and feel free to submit pull requests or open issues.
